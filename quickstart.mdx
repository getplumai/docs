...
![Upload a dataset](/images/quickstart/00_upload.png)
...
![Generate metrics](/images/quickstart/03_generate_metrics.png)

You can edit these metrics to modify them or add your own.

![Show metrics](/images/quickstart/04_show_metrics.png)
...
![Run evaluations](/images/quickstart/05_run_evals.png)

Click "Run Evaluation" and Plum AI will provide a statistical analysis of your outputs within seconds.

![Evaluation results](/images/quickstart/06_eval_results.png)
